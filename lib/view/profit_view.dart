                  ...
                  Column(children: [
                    customTextField(
                      ...
                      controller: controller.amountController,
                        ...
                        onChanged: (value){
                        if(double.parse(controller.amountController.text) <= 1000000) {
                    ...
                    Padding(
                      ...
                      child: customTextField(
                        ...
                        controller: controller.buyPriceController,
                          ...
                          textInputType: TextInputType.number,
                          onChanged: (value){
                            if(double.parse(controller.buyPriceController.text) <= 1000000) {
                    ...
                    customTextField(
                      ...
                      controller: controller.sellPriceController,
                        ...
                        textInputType: TextInputType.number,
                        onChanged: (value){
                          if(double.parse(controller.sellPriceController.text) <= 1000000) {
                            controller.sellPrice = double.parse(controller.sellPriceController.text);
                          }else{
